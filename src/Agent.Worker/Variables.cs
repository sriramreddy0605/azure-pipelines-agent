...
namespace Microsoft.VisualStudio.Services.Agent.Worker
{
    ...
    public sealed class Variables
    {
        ...
        public static readonly List<string> VariablesVulnerableToExecution = new List<string>
        {
            ...
            Constants.Variables.Build.RequestedForEmail,
            ...
            Constants.Variables.Release.ReleaseDeploymentRequestedForEmail,
            Constants.Variables.Release.ReleaseEnvironmentName,
            Constants.Variables.Release.ReleaseRequestedForEmail,
